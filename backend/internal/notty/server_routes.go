...
func (s *Server) Routes() http.Handler {
	...
	router.Get("/api/workspace/sync", s.handleWorkspaceSync)
	router.Get("/api/documents", s.handleDocuments)
	router.Get("/api/documents/by-path", s.handleDocumentByPath)
	router.Post("/api/documents", s.handleCreateDocument)
	router.Get("/api/documents/{id}", s.handleDocument)
	router.Post("/api/documents/{id}/sync", s.handleDocumentSync)
	...
	router.Post("/api/documents/{id}/updates", s.handleApplyUpdate)
