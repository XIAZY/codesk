...
func TestRouteTableMatchesAuthenticatedWorkspaceAllowlist(t *testing.T) {
	...
	workspaceAPI := map[string]bool{
		...
		"GET /api/workspaces/{workspaceID}/agents/{id}/document-subscriptions":                 true,
		"POST /api/workspaces/{workspaceID}/agents/{id}/document-subscriptions":                true,
		"DELETE /api/workspaces/{workspaceID}/agents/{id}/document-subscriptions/{documentID}": true,
	}
