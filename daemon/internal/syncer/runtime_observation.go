...
// RuntimeObserver receives token-free runtime lifecycle observations. The
// implementation must return promptly; observations are emitted from runtime
// lifecycle paths and are diagnostics, not a second source of product state.
