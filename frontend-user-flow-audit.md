...
- `documentCache` stores per-document state/pending/outbox data under daemon cache.
- Workspace-specific projected bases live under each workspace root’s `.notty/projections`.
